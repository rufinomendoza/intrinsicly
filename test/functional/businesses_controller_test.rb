...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { industry: @business.industry, name: @business.name, terminal: @business.terminal, wacc: @business.wacc }
    end
  ...
  test "should update business" do
    put :update, id: @business, business: { industry: @business.industry, name: @business.name, terminal: @business.terminal, wacc: @business.wacc }
    assert_redirected_to business_path(assigns(:business))
  end
